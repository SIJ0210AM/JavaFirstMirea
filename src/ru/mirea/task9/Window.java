...
public class Window extends JFrame {
    ...
    public Window() {
        ...
        Score.setBackground(new Color(0,0,255));
        ...
        LastScorer.setBackground(new Color(255,0,0));
